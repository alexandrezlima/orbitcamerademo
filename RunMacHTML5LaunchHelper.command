...
EPIC_MONO=""
if [ -f "X:\SteamLibrary\steamapps\common\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "X:\SteamLibrary\steamapps\common\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'X:\SteamLibrary\steamapps\common\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
